...
- `1.0.4` — `versionName`, отображаемая версия;
- `13` — `versionCode`, который должен увеличиваться при каждой публикации.
...
## 5.2. Требования к следующей сборке
...
## 5.3. Предыдущая сборка 2026-07-08

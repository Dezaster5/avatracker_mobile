...
Play нужно повторно собрать AAB после подключения `android/key.properties`.

## 5.2. Предыдущая внутренняя сборка 2026-07-22
...
## 5.3. Отозванная сборка 2026-07-13
...
## 5.4. Проверка на физическом устройстве

Перед публикацией версии 1.0.7 на физическом устройстве обязательно проверить:
...
- отметка лица проходит без системного звука затвора;
- отметки `00:00–02:59` отображаются в предыдущем рабочем дне, а отметка с
  `03:00` — уже в новом.

## 5.5. Предыдущая сборка 2026-07-08

...
AvaTracker. Текущая версия исходного кода: `1.0.7+16`.
...
При одной отметке уход остаётся «Не отмечено». Аналитика опозданий
берётся из `/api/v1/tardiness/`, а время графика — из
